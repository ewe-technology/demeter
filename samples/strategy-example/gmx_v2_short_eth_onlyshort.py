...
class GmxV2LpStrategy(Strategy):
    ...
    def work(self, snapshot: Snapshot):
        ...
        self.mark_price = snapshot.prices["WETH"]
        pass
...
if __name__ == "__main__":
    ...
    print(f"==>> initial value: {INIT_USDC}, data_start_date: {DATA_START_DATE}, _START_DATE: {start_date}, _END_DATE: {end_date}, time interval (minute): {CHECK_INTERVAL_MIN}, take profit percent: {CLOSE_PERCENT}, stop loss percent: {STOP_LOSS_PERCENT}")
